  ...
  return (
    <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-100 dark:border-gray-700/50 overflow-hidden">
      ...
      {(searchable || filterable || exportable) && (
        <div className="p-sm border-b border-gray-100 dark:border-gray-700/50">
            ...
            {searchable && (
              <div className="flex-1 max-w-lg">
                <input
                  ...
                  className="w-full px-sm py-xs bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all"
                />
              </div>
            )}
